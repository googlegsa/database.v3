...
public class MimeTypeFinder {
  ...
  private static final MimeUtil2 delegate = new MimeUtil2();
   ...
   * set. Since the supported encodings is stored as a static Set we synchronize
   * access.
   */
  ...
  public String find(InputStream file, TraversalContext traversalContext) {
  ...
  private Collection<MimeType> getMimeTypes(InputStream file) {
