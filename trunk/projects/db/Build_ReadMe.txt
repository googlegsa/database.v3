...
========================================================================================
1. Ensure that you have Apache Ant 1.8, Subversion 1.6, Tomcat 7 and JDK 1.6 installed on your system.
   For details, see the "Prerequisites" section here:
...
2. Ensure that you have Connector Manager on your system. You can get it at
   ...
   2b) Follow the instructions for building the Connector Manager as described here:
       http://code.google.com/p/google-enterprise-connector-manager/wiki/DeveloperEnvironmentSetup
   2c) Execute Ant target "ant install-all" to build the Connector Manager jar files.
       If you get compile errors "package javax.jcr does not exist", go back to the
       previous step and make sure JCR was installed correctly.
